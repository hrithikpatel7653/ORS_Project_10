...
var BaseListCtl = /** @class */ (function (_super) {
    ...
    BaseListCtl.prototype.submit = function () {
        ...
        if (this.form.searchParams.roleId == "undefined" ||
            ...
            console.log("firstname name search enter if condition");
...
var UserComponent = /** @class */ (function (_super) {
    ...
    UserComponent.prototype.submit = function () {
        ...
        this.serviceLocator.httpService.post(this.api.save, this.form.data, function (res) {
            ...
            if (res.success) {
                _self.form.message = "LoginId is already Exit...!!!";
                _self.form.data.id = res.result.data;
                console.log(_self.form.data.id);
                console.log("----------Basant----------.");
            }
...
module.exports = __webpack_require__(/*! C:\Users\DELL\Desktop\ORS_Project_10\ORSProject10-UI\src\main.ts */"./src/main.ts");
